...
.text-end {
  ...
  const fetchEstimateData = async () => {
    try {
      ...
      const response = await fetch(`https://immaculate-qlaf.vercel.app/api/getemailestimatedata/${estimateId}`, {
        // headers: {
  ...
  const fetchsignupdata = async () => {
    try {
      ...
      // const userid =   localStorage.getItem("userid");
      // const authToken = localStorage.getItem('authToken');
      const response = await fetch(`https://immaculate-qlaf.vercel.app/api/getemailsignupdata/${userId}`, {
        // headers: {
        //   'Authorization': authToken,
        // }
      });
  ...
  const fetchtransactiondata = async () => {
    try {
      // const userid = localStorage.getItem("userid");
      // const authToken = localStorage.getItem('authToken');
      const response = await fetch(`https://immaculate-qlaf.vercel.app/api/getemailtransactiondata/${estimateId}`, {
        // headers: {
        //   'Authorization': authToken,
        // }
      });
  ...
  const fetchOwnerData = async () => {
    try {
      ...
      // const authToken = localStorage.getItem('authToken');
      const response = await fetch(`https://immaculate-qlaf.vercel.app/api/getemailownerdata/${ownerId}`, {
        // headers: {
        //   'Authorization': authToken,
        // }
      });
  ...
  const checkCustomerSignature = async (estimateIdpass) => {
    ...
    try {
      const response = await fetch(`https://immaculate-qlaf.vercel.app/api/checkcustomersignature/${encodeURIComponent(estimateIdpass)}`);
      const json = await response.json();
  ...
  const handleSignatureClick = async () => {
    ...
    try {
      ...
      const checkResponse = await fetch(`https://immaculate-qlaf.vercel.app/api/checkcustomersignature/${encodeURIComponent(estimateData._id)}`);
      const checkJson = await checkResponse.json();

      if (checkJson.hasSignature) {
        // Update the existing customer signature
        const updateResponse = await fetch(`https://immaculate-qlaf.vercel.app/api/updatecustomersignature/${encodeURIComponent(estimateData._id)}`, {
          method: 'PUT',
          headers: {
  ...
  const handleDocumentComplete = async () => {
    try {
      ...
      const emailResponse = await fetch('https://immaculate-qlaf.vercel.app/api/send-estimate-signed-email', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
