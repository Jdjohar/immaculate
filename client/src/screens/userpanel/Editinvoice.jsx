...
export default function Editinvoice() {
    ...
    const fetchInvoiceData = async () => {
        try {
            ...
            const response = await fetch(`hhttps://immaculate.onrender.com/api/geteditinvoicedata/${invoiceid}`, {
                headers: {
    ...
    const handleSaveClick = async () => {
        try {
            ...
            const authToken = localStorage.getItem('authToken');
            const response = await fetch(`hhttps://immaculate.onrender.com/api/updateinvoicedata/${invoiceid}`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    'Authorization': authToken,
    ...
    const handleDeleteClick = async (itemId) => {
        try {
            ...
            const authToken = localStorage.getItem('authToken');
            const response = await fetch(`hhttps://immaculate.onrender.com/api/delinvoiceitem/${invoiceData._id}/${itemId}`, {
                method: 'GET',
                headers: {
                    'Authorization': authToken,
                }
