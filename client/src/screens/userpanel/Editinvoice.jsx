...
export default function Editinvoice() {
    ...
    const fetchInvoiceData = async () => {
        try {
            ...
            const response = await fetch(`https://immaculate-qlaf.vercel.app/api/geteditinvoicedata/${invoiceid}`, {
                headers: {
    ...
    const handleSaveClick = async () => {
        try {
            ...
            const authToken = localStorage.getItem('authToken');
            const response = await fetch(`https://immaculate-qlaf.vercel.app/api/updateinvoicedata/${invoiceid}`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    'Authorization': authToken,
    ...
    const handleDeleteClick = async (itemId) => {
        try {
            ...
            const authToken = localStorage.getItem('authToken');
            const response = await fetch(`https://immaculate-qlaf.vercel.app/api/delinvoiceitem/${invoiceData._id}/${itemId}`, {
                method: 'GET',
                headers: {
                    'Authorization': authToken,
                }
                                                                    ...
                                                                    invoiceData.items.map((item) => (
                                                                        <tr key={item.itemId}>
                                                                            ...
                                                                            <td>
                                                                                ...
                                                                                {/* Description Field */}
                                                                                <div className="mt-3">
                                                                                    <label htmlFor={`description-${item.itemId}`} className="form-label">
                                                                                        Description
                                                                                    </label>
                                                                                    <CKEditor
                                                                                        editor={ClassicEditor}
                                                                                        data={item.description} // Ensure item.description is valid
