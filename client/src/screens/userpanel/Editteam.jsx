...
export default function Editteam() {
    ...
    const fetchteamData = async () => {
        try {
            ...
            const response = await fetch(`https://immaculate.onrender.com/api/getteamdata/${teamid}`, {
                headers: {
    ...
    const handleSaveClick = async () => {
        try {
            ...
            const authToken = localStorage.getItem('authToken');
            const response = await fetch(`https://immaculate.onrender.com/api/updateteamdata/${teamid}`, {
                method: 'POST',
                headers: {
