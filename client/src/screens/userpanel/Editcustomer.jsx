...
export default function Editcustomer() {
    ...
    const fetchCustomerData = async () => {
        try {
            ...
            const response = await fetch(`https://immaculate-qlaf.vercel.app/api/getcustomers/${customerId}`, {
                headers: {
    ...
    const handleSaveClick = async () => {
        try {
            ...
            const authToken = localStorage.getItem('authToken');
            const response = await fetch(`https://immaculate-qlaf.vercel.app/api/updatecostomerdata/${customerId}`, {
                method: 'POST',
                headers: {
