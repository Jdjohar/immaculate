...
export default function Edititem() {
    ...
    const fetchitemData = async () => {
        try {
            ...
            const response = await fetch(`hhttps://immaculate.onrender.com/api/getitems/${itemId}`, {
                headers: {
    ...
    const handleSaveClick = async () => {
        try {
            ...
            const authToken = localStorage.getItem('authToken');
            const response = await fetch(`hhttps://immaculate.onrender.com/api/updateitemdata/${itemId}`, {
                method: 'POST',
                headers: {
