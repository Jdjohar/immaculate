...
export default function Edititem() {
    ...
    const fetchitemData = async () => {
        try {
            ...
            const response = await fetch(`https://immaculate-qlaf.vercel.app/api/getitems/${itemId}`, {
                headers: {
    ...
    const handleSaveClick = async () => {
        try {
            ...
            const authToken = localStorage.getItem('authToken');
            const response = await fetch(`https://immaculate-qlaf.vercel.app/api/updateitemdata/${itemId}`, {
                method: 'POST',
                headers: {
