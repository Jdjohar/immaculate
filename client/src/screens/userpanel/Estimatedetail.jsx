...
export default function Estimatedetail() {
  ...
  const fetchestimateData = async () => {
    try {
      ...
      const response = await fetch(`https://immaculate-qlaf.vercel.app/api/getestimatedata/${estimateid}`, {
        headers: {
  ...
  const fetchtransactiondata = async () => {
    try {
      const userid = localStorage.getItem("userid");
      const authToken = localStorage.getItem('authToken');
      const response = await fetch(`https://immaculate-qlaf.vercel.app/api/gettransactiondata/${estimateid}`, {
        headers: {
          'Authorization': authToken,
        }
      });
...
.text-end {
  ...
  const handleRemove = async (estimateid, estimateIdpass) => {
    ...
    try {
      ...
      if (signatureData) {
        const authToken = localStorage.getItem('authToken');
        const deleteSignatureResponse = await fetch(`https://immaculate-qlaf.vercel.app/api/delcustomersignature/${encodeURIComponent(estimateIdpass)}`, {
          method: 'DELETE',
          headers: {
            'Authorization': authToken,
          }
      ...
      const authToken = localStorage.getItem('authToken');
      const response = await fetch(`https://immaculate-qlaf.vercel.app/api/delestimatedata/${estimateid}`, {
        method: 'GET',
        headers: {
          'Authorization': authToken,
        }
  ...
  const handleFormSubmit = async (event) => {
    ...
    try {
      ...
      const response = await fetch('https://immaculate-qlaf.vercel.app/api/send-estimate-email', {
        method: 'POST',
        headers: {
      ...
      if (response.ok) {
        ...
        await fetch(`https://immaculate-qlaf.vercel.app/api/updateestimateData/${estimateid}`, {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json',
            'Authorization': authToken,
