...
.text-end {
  ...
  const fetchinvoiceData = async () => {
    try {
      ...
      const response = await fetch(`https://immaculate.onrender.com/api/getemailinvoiceData/${invoiceId}`, {
        // headers: {
  ...
  const fetchtransactiondata = async () => {
    try {
      // const userid = localStorage.getItem("userid");
      // const authToken = localStorage.getItem('authToken');
      const response = await fetch(`https://immaculate.onrender.com/api/getemailtransactiondata/${invoiceId}`, {
        // headers: {
        //   'Authorization': authToken,
        // }
      });
  ...
  const handleDocumentComplete = async () => {
    try {
      ...
      const emailResponse = await fetch('https://immaculate.onrender.com/api/send-Invoice-signed-email', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
  ...
  //     // Send email request to backend
  //     const response = await fetch('https://immaculate.onrender.com/api/send-Invoice-signed-email', {
  //       method: 'POST',
  //       headers: {
  //         'Content-Type': 'application/json',
  //       },
